...
# Step 4: Deploy with simple SSL configuration
print_status "🔨 Building and starting containers with simple SSL..."
...
if curl -f -k https://$SERVER_IP:8443/health > /dev/null 2>&1; then
    ...
    docker-compose -f docker-compose-simple-ssl.yml logs --tail=20
fi

# Show container status
print_status "📊 Container status:"
docker-compose -f docker-compose-simple-ssl.yml ps

# Show useful commands
print_status "📝 Useful commands:"
echo "   • View logs: docker-compose -f docker-compose-simple-ssl.yml logs -f"
echo "   • Restart: docker-compose -f docker-compose-simple-ssl.yml restart"
echo "   • Stop: docker-compose -f docker-compose-simple-ssl.yml down"
echo "   • Rebuild: docker-compose -f docker-compose-simple-ssl.yml up -d --build"
